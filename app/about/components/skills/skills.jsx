...
const skillCategories = {
	construction: {
		...
		icon: CodepenIcon,
		description: "Pengerjaan fisik, renovasi, dan perancangan tata ruang",
		languages: [
			{ name: "Drywall Installation", highlight: true },
			{ name: "Interior Maintenance", highlight: true },
			{ name: "Space Planning", highlight: false },
			{ name: "Material Estimation", highlight: false },
		],
		tools: ["Power Tools", "Measuring Instruments", "Scaffolding"],
	},
	mep: {
		...
		languages: [
			{ name: "Electrical Wiring", highlight: true },
			{ name: "Circuit Troubleshooting", highlight: true },
			{ name: "Panel Installation", highlight: false },
			{ name: "Safety Compliance", highlight: true },
		],
		tools: ["Multimeter", "Wire Strippers", "Industrial Equipment"],
	},
	web: {
		title: "Web Development",
		icon: WebhookIcon,
		description: "Membangun antarmuka web yang modern dan responsif",
		languages: [
		...
		tools: ["Vercel", "Git", "GitHub", "Figma", "VS Code"],
	},
	web3: {
		title: "Web3 & Blockchain",
		icon: MobileIcon,
		description: "Integrasi DApps dan interaksi dengan Smart Contract",
		languages: [
			{ name: "Web3 Integration", highlight: true },
			{ name: "DEX Interfaces", highlight: true },
			{ name: "Staking Dashboards", highlight: true },
			{ name: "Ethers.js", highlight: false },
		],
		tools: ["MetaMask", "Blockchain Explorers", "RPC Nodes"],
	},
};
